        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="relative w-full">
            ...
            <div className="relative z-10 mb-4 sm:mb-5 md:mb-6 flex items-start gap-2 sm:gap-3">
              ...
              <p className="font-montserrat text-[#111111] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18px] leading-[1.5em] tracking-[0.5%] flex-1 min-w-0">
                Привіт. Ми — Руслан та Наталя, подружжя та засновники центру «Справжні». А ще — родина, яка добре знає: інколи дві галочки в Signal під прочитаним повідомленням можуть бути цілющими.
              </p>
            </div>

            {/* Second Paragraph */}
            <p className="relative z-10 font-montserrat text-[#111111] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18px] leading-[1.5em] tracking-[0.5%] ml-[calc(4rem+0.5rem)] sm:ml-[calc(5rem+0.75rem)] md:ml-[calc(6rem+0.75rem)] lg:ml-[calc(7rem+0.75rem)]">
          ...
          <div className="flex flex-col w-full">
            {/* First Paragraph */}
            <p className="font-montserrat text-[#111111] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18px] leading-[1.5em] tracking-[0.5%] mb-4 sm:mb-5 md:mb-6 max-w-[calc(100%-4rem-0.5rem)] sm:max-w-[calc(100%-5rem-0.75rem)] md:max-w-[calc(100%-6rem-0.75rem)] lg:max-w-[calc(100%-7rem-0.75rem)]">
            ...
            {/* Second Paragraph */}
            <p className="font-montserrat text-[#111111] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18px] leading-[1.5em] tracking-[0.5%] mb-6 sm:mb-7 md:mb-8 max-w-[calc(100%-4rem-0.5rem)] sm:max-w-[calc(100%-5rem-0.75rem)] md:max-w-[calc(100%-6rem-0.75rem)] lg:max-w-[calc(100%-7rem-0.75rem)]">
