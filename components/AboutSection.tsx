      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="relative">
            {/* First Paragraph */}
            <p className="relative z-10 text-[#111111] text-[16px] md:text-[17px] lg:text-[18px] leading-[1.5em] tracking-[0.5%] mb-6 flex items-start gap-3">
            ...
            {/* Second Paragraph */}
            <p className="relative z-10 text-[#111111] text-[16px] md:text-[17px] lg:text-[18px] leading-[1.5em] tracking-[0.5%]">
          ...
          <div className="flex flex-col">
            {/* First Paragraph */}
            <p className="text-[#111111] text-[16px] md:text-[17px] lg:text-[18px] leading-[1.5em] tracking-[0.5%] mb-6">
            ...
            {/* Second Paragraph */}
            <p className="text-[#111111] text-[16px] md:text-[17px] lg:text-[18px] leading-[1.5em] tracking-[0.5%] mb-8">
            ...
            <div className="mt-auto flex justify-end lg:justify-start">
              <a 
                href="#continue" 
                className="text-[#28694D] text-[16px] md:text-[17px] lg:text-[18px] font-medium hover:opacity-80 transition-opacity inline-block underline"
              >
                Читати продовження
              </a>
            </div>
